...
class GroupDetailsFragment: Fragment(R.layout.fragment_group_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addStudent.visibility = if (role == UserRole.TEACHER) View.VISIBLE else View.GONE
        binding.addTeacher.visibility = if (role == UserRole.TEACHER) View.VISIBLE else View.GONE

        studentListAdapter =
            GroupDetailsAdapter(
                GroupDetailsAdapter.OnClickListener {
                    showStudent(
                        it
                    )
                }
